#!/usr/bin/env python3
"""Verify crates.io publishes are visible at the expected version.

Retries on crates.io API payloads that temporarily lack crate metadata (the
index and the web API propagate a published version with a short lag).
"""
...
USER_AGENT = "agentyk-publish-verifier/1.0"
